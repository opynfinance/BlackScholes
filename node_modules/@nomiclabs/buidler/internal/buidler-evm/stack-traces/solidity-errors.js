...
function sourceReferenceToSolidityCallsite(sourceReference) {
    return new SolidityCallSite(sourceReference.fileGlobalName, sourceReference.contract, sourceReference.function !== undefined
...
class SolidityCallSite {
    constructor(_fileGlobalName, _contract, _functionName, _line) {
        this._fileGlobalName = _fileGlobalName;
