...
export declare class SourceFile {
    ...
    constructor(globalName: string, content: string);
...
export declare class Contract {
    ...
    getFunctionFromSelector(selector: Buffer): ContractFunction | undefined;
    /**
...
export declare class ContractFunction {
    ...
    selector?: Buffer | undefined;
    constructor(name: string, type: ContractFunctionType, location: SourceLocation, contract: Contract, visibility?: ContractFunctionVisibility | undefined, isPayable?: boolean | undefined, selector?: Buffer | undefined);
}
...
export declare class Bytecode {
    ...
    constructor(contract: Contract, isDeployment: boolean, normalizedCode: Buffer, instructions: Instruction[], libraryAddressPositions: number[], compilerVersion: string);
