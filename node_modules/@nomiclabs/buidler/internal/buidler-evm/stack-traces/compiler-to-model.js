...
function decodeEvmBytecode(contract, solcVersion, isDeployment, compilerBytecode, fileIdToSourceFile) {
    ...
    const instructions = source_maps_1.decodeInstructions(normalizedCode, compilerBytecode.sourceMap, fileIdToSourceFile);
    return new model_1.Bytecode(contract, isDeployment, normalizedCode, instructions, libraryAddressPositions, solcVersion);
}
