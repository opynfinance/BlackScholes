...
(function (ContractFunctionType) {
    ...
    ContractFunctionType[ContractFunctionType["GETTER"] = 3] = "GETTER";
    ContractFunctionType[ContractFunctionType["MODIFIER"] = 4] = "MODIFIER";
...
class SourceFile {
    constructor(globalName, content) {
...
class Bytecode {
    constructor(contract, isDeployment, normalizedCode, instructions, libraryAddressPositions, compilerVersion) {
        this.contract = contract;
