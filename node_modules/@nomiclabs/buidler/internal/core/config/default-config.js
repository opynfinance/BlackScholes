...
exports.BUIDLEREVM_DEFAULT_GAS_PRICE = 8e9;
const DEFAULT_BUIDLER_NETWORK_CONFIG = {
    hardfork: "istanbul",
    blockGasLimit: 9500000,
    gas: 9500000,
    gasPrice: exports.BUIDLEREVM_DEFAULT_GAS_PRICE,
    chainId: 31337,
...
const defaultConfig = {
    defaultNetwork: constants_1.BUIDLEREVM_NETWORK_NAME,
    solc: {
    ...
    networks: {
        [constants_1.BUIDLEREVM_NETWORK_NAME]: DEFAULT_BUIDLER_NETWORK_CONFIG,
        localhost: {
